...
export default function ChatItem({
  ...
  const getIcon = (type: string) => {
    switch (type) {
      case "image":
        return <Camera size={14} className="inline mr-1" />;
      case "video":
        return <Video size={14} className="inline mr-1" />;
      case "file":
        return <FileText size={14} className="inline mr-1" />;
      default:
        return null;
    }
  };
      ...
      <div className="ml-4 flex-1 min-w-0">
        <div className="flex justify-between items-baseline mb-0.5">
          <h3
            ...
            style={!isActive ? { color: theme.textMain } : {}}
          >
            {contact.name}
          </h3>
          ...
          <span
            ...
            style={!isActive && !isTyping ? { color: theme.textSec } : {}}
          >
        ...
        <div className="flex items-center justify-between">
          <p
            className={`text-sm truncate font-medium flex items-center ${
              isActive ? "text-indigo-100" : isTyping ? "text-indigo-500" : ""
            }`}
            style={!isActive && !isTyping ? { color: theme.textSec } : {}}
          >
            ...
            {isTyping ? (
              ...
              <>
                ...
                {contact.lastMessageDoc?.sender === "me" &&
