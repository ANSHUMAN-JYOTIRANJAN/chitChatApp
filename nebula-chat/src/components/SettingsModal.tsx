      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div
              className="flex items-center px-4 py-3 rounded-xl border-2 transition-colors focus-within:border-indigo-500"
              style={{
          ...
          <div>
            ...
            <div
              className="flex items-center px-4 py-3 rounded-xl border-2 transition-colors opacity-60 cursor-not-allowed"
              style={{
                backgroundColor: theme.inputBg,
                borderColor: theme.border,
              }}
            ...
            <p className="text-[10px] mt-1 opacity-50 ml-1">
          ...
          <div>
            ...
            <div
              className="flex items-start px-4 py-3 rounded-xl border-2 transition-colors focus-within:border-indigo-500"
              style={{
                backgroundColor: theme.inputBg,
                borderColor: theme.border,
              }}
